...
$displayusername = $usr['displayname'];
}
$robux = $usr['Robux'];
...
?>
{"UserId":<?=$uID;?>,"Username":"<?=$username;?>","DisplayName":"<?=$displayusername;?>","HasPasswordSet":true,"Email":null,"AgeBracket":0,"Roles":[],"MembershipType":<?=$MembValue;?>,"RobuxBalance":<?=$robux;?>,"NotificationCount":0,"EmailNotificationEnabled":false,"PasswordNotificationEnabled":false}
