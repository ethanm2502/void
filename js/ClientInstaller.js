...
Roblox.Client.GetInstallHost = function (o) {
	...
	{
		return "roblonium.com"; // remove when not testing
	}
};
...
// Define the ROBLONIUM URI launcher object functions
	...
	pluginObj.StartGame = function(authenticationUrl, visitUrl) {
		...
		document.getElementById("downloadInstallerIFrame").src = "roblonium-player:1+launchmode:play+gameinfo:" + pluginObj.AuthenticationTicket + "+placelauncherurl:" + visitUrl;
